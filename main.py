...
wrag1 = Player(1000,1000,100,100, 'wrag.png')
    ...
    if level1:
        ...
        if player.rect.colliderect(door.rect): # настройки для lvl 3
            ...
            walls = [Wall(0,550,1000,300), # 
                     ...
                     Wall(0,750,1000,50),
                     Wall(1000,0,100,1000)]
            door.rect.x, door.rect.y = 500,150
        ...
        mw.blit(coin.image, (coin.rect.x, coin.rect.y))
        mw.blit(coin1.image, (coin1.rect.x, coin1.rect.y))
        if wrag.rect.colliderect(player.rect):
        ...
        if player.rect.colliderect(door.rect):# настройки для lvl4
            player.rect.x = 50
            player.rect.y = 400
            player.vel_y = 0
            player.can_jump = True
            walls = [Wall(0,550,1000,300), # 
                     ...
                     Wall(0,750,1000,50),
                     Wall(1000,0,100,1000)]
            door.rect.x, door.rect.y = 50,50
            coin.rect.x, coin.rect.y = 900, 450
            coin1.rect.x, coin1.rect.y = 500, 300
            coin2.rect.x, coin2.rect.y = 900, 0
            coin3.rect.x, coin3.rect.y = 300,100
            wrag.rect.x, wrag.rect.y = 400, 465
            wrag1.rect.x, wrag1.rect.y = 700, 465
            level3 = False
            level4 = True
    elif level4:
        mw.blit(door.image, (door.rect.x, door.rect.y))
        mw.blit(player.image, (player.rect.x, player.rect.y))
        mw.blit(wrag.image, (wrag.rect.x, wrag.rect.y))
        mw.blit(wrag1.image, (wrag1.rect.x, wrag1.rect.y))
        mw.blit(coin.image, (coin.rect.x, coin.rect.y))
        mw.blit(coin1.image, (coin1.rect.x, coin1.rect.y))
        mw.blit(coin2.image, (coin2.rect.x, coin2.rect.y))
        mw.blit(coin3.image, (coin3.rect.x, coin3.rect.y))
        ...
        #     player.rect.x, player.rect.y = 50, 400
        wrag.enemy_move()
        # if wrag1.rect.colliderect(player.rect):
        #     player.rect.x, player.rect.y = 50, 400
        wrag1.enemy_move()
        if player.rect.colliderect(coin.rect):
            coin.rect.x = 2000
        ...
        if player.rect.colliderect(coin3.rect):
            coin3.rect.x = 2000
            coins += 1
        if player.rect.colliderect(wrag.rect):
            wrag.rect.y = 2000
            coins += 1 
        if player.rect.colliderect(wrag1.rect):
            wrag1.rect.y = 2000
            coins += 1 
        if coins == 6:
            walls.pop(7)
